  ...
  return (
    <div>
      <div onClick={handlePlay} className="cursor-pointer">
        <div className="group group-hover:opactity-75 relative aspect-square w-full overflow-hidden rounded-md bg-gray-200">
          {song.thumbnailUrl ? (
            <img
            ...
            <div className="bg-muted w-ful flex h-full items-center justify-center">
