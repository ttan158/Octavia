...
export default function SoundBar() {
  ...
  return (
    <div className="px-4 pb-2">
      <Card className="bg-background/60 relatve shrink=0 w-full border-t py-0 backdrop-blur">
            ...
            <div className="flex min-w-0 flex-1 items-center gap-2">
              <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-md bg-gradient-to-br from-purple-500 to-pink-500">
                {track?.artwork ? (
                  ...
                  <Music className="h-4 w-4 text-white"></Music>
                )}
              </div>
              <div className="max-w-24 min-w-0 flex-1 md:max-w-full">
                <p className="truncate text-sm font-medium">{track?.title}</p>
                <p className="text-muted-foregroudn truncate text-xs">
