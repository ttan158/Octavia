      ...
      <div className="flex-1 p-6">
        ...
        <div className="space-y-2">
          {filteredTracks.length > 0 ? (
              ...
              switch (track.status) {
                ...
                default:
                  return (
                    <div
                      key={track.id}
                      className="hover:bg-muted/50 rounded-;g transition-clors flex cursor-pointer items-center gap-4 p-3"
            ...
            <div className="pt20 flex flex-col items-center justify-center text-center">
              <Music className="text-muted-foregroud h-10 w-10" />
